...
class ContentKNNAlgorithm(AlgoBase):
    ...
    def computeGenreSimilarity(self, movie, novel, genres):
        genres1 = genres[movie]
        genres2 = genres[novel]
    ...
    def computeYearSimilarity(self, movie, novel, years):
        diff = abs(years[movie] - years[novel])
        sim = math.exp(-diff / 10.0)
        return sim
    
    def computeMiseEnSceneSimilarity(self, movie, novel, mes):
        mes1 = mes[movie]
        mes2 = mes[novel]
        if (mes1 and mes2):
